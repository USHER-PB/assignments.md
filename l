...
23-     
  ...
  ifconfig <ip address> etho  for ipv4

  ifconfig <ipv6 address> etho 
...
26-
   edit a /etc/nologin file 

27- 
    iptables is a table that contain ip enteriesv while ufw is use to to enable or disble firewall on your mahcine 
